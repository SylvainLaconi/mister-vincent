...
export default function Home() {
	return (
		<main className="flex min-h-screen flex-col items-center">
			...
			>
				<h1 className="text-5xl font-semibold text-center text-[#c6d200]">
					Mister Vincent
				</h1>
				...
				<p className="pt-10 text-center text-black">
					Mon site est en construction, mais je suis prêt à vous aider !
				</p>

				<p className="pt-5 text-center text-black">
					Contactez-moi au{' '}
