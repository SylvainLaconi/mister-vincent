			...
			<div className="flex flex-col lg:flex-row xl:flex-row 2xl:flex-row justify-center gap-10">
				...
				<div className="flex flex-col w-full lg:w-2/3 xl:w-2/3 2xl:w-2/3 gap-5 items-start justify-center">
					...
					<p className="text-black leading-loose text-justify">
						...
						management dans la grande distribution, j'ai acquis l'adaptabilité,
						la discipline et le sens des priorités. Je suis calme, honnête et à
						l'écoute de vos besoins et de vos contraintes.
					</p>
					<p className="text-black leading-loose text-justify">
						Que ce soit seul, avec vous ou via une séance de coaching, mon
						objectif est de vous aider à prendre ou reprendre possession de vos
						espaces de vie ou de travail afin que vous vous y sentiez bien, en
						adaptant les solutions de rangement à vos désirs.
					</p>
				</div>
			</div>
		</SectionLayout>
